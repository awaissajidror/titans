...
$(document).ready(function () {
  ...
  $('.mark-attendance').on('change', function () {
    ...
    var status = checkbox.attr('id').split('-')[1];
    var userId = checkbox.attr('id').split('-')[2];
    $.ajax({
      url: "/attendances/".concat(userId),
      type: 'POST',
      data: {
        day: day,
        status: status,
...
/******/ });
//# sourceMappingURL=custom-475ff6816eea798dd84e.js.map