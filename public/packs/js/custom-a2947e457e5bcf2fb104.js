...
/* WEBPACK VAR INJECTION */(function($) {// Custom JS
$(document).ready(function () {
  ...
  $('#show-calculations').click(function () {
    ...
    var totalCash = $('#total-cash').val();
    var totalCard = $('#total-card').val();
    var totalEft = $('#total-eft').val();
    var totalRefund = $('#total-refund').val();

    // Calculations
    var sum = (parseFloat(totalCash) + parseFloat(totalCard) + parseFloat(totalEft)).toFixed(2);
    var subTotal = "".concat(sum, " - ").concat(totalRefund);
    var total = sum - totalRefund;
  ...
  roleDropdown.on('change', function () {
    ...
    // If the selected role is "Labour",
    if (role === 'Labour') {
      // Show the month and week dropdowns
      ...
      // Hide the month and week dropdowns
      $('.hide').hide();
    }
  });
  ...
  $('.mark-attendance').on('change', function () {
    var checkbox = $(this);
    var day = checkbox.attr('id').split('-')[0];
    var month = checkbox.attr('id').split('-')[1];
    var year = checkbox.attr('id').split('-')[2];
    var status = checkbox.attr('id').split('-')[3];
    var user_id = checkbox.attr('id').split('-')[4];
    ...
    $.ajax({
      ...
      error: function error(xhr, status, _error) {
        console.log('Error updating attendance:', _error);
      }
    });
  });
  ...
  $(".sa-phone-input").on('focus', function () {
    var inputValue = $(this).val().replace(/\D/g, "").substring(0, 11);
    if (inputValue === '') {
      $(this).val('+27 ');
    }
  }).on('input', function () {
    var countryCode = '+27';
    var inputValue = $(this).val().replace(/\D/g, '').substring(0, 11);
    var areaCode = inputValue.substring(2, 4);
    var middle = inputValue.substring(4, 7);
    var last = inputValue.substring(7, 11);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var recent_movement = $('#recent_movement-container').data('source');
  var monthNames = recent_movement.map(function (obj) {
    return obj.month;
  });
  var salesData = recent_movement.map(function (obj) {
    return obj.sales;
  });
...
/******/ });
//# sourceMappingURL=custom-a2947e457e5bcf2fb104.js.map